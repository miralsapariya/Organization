...
public class CoursechartDatum {
    ...
    @Expose
    private List<CourseYaxisLabel> courseYaxisLabel = null;
    ...
    public List<CourseYaxisLabel> getCourseYaxisLabel() {
        return courseYaxisLabel;
    }

    public void setCourseYaxisLabel(List<CourseYaxisLabel> courseYaxisLabel) {
...
public class Datum {
    ...
    @Expose
    private List<MostCompletedCourse> mostCompletedCourses = null;
    @SerializedName("coursechart_dropdownlist")
    @Expose
    private List<CoursechartDropdownlist> coursechartDropdownlist = null;
    ...
    public List<MostCompletedCourse> getMostCompletedCourses() {
        return mostCompletedCourses;
    }

    public void setMostCompletedCourses(List<MostCompletedCourse> mostCompletedCourses) {
        this.mostCompletedCourses = mostCompletedCourses;
    }

    public List<CoursechartDropdownlist> getCoursechartDropdownlist() {
        return coursechartDropdownlist;
    }

    public void setCoursechartDropdownlist(List<CoursechartDropdownlist> coursechartDropdownlist) {
